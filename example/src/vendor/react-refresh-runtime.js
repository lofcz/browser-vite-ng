    ...
    exports.performReactRefresh = function () {
      try {
        if (typeof window !== "undefined") {
          window.__rr_pending = pendingUpdates.length;
          window.__rr_mountedRoots = mountedRoots.size;
        }
      } catch (e) {}
      ...
      try {
        ...
        updates.forEach(function (_ref) {
          ...
          try {
            if (typeof window !== "undefined") {
              window.__rr_sigCur = prevType ? "sig" : "none";
              window.__rr_sigNext = _ref ? "preserve" : "STALE";
            }
          } catch (e) {}
        });
        var update = {
