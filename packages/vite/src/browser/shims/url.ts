...
export function fileURLToPath(url: string | URL): string {
  ...
  // BROWSER-VITE: Node throws for non-file: URLs, but in the fork
  // `import.meta.url` is a browser URL (http://localhost/... or /@fs/...) used
  // purely to derive a VFS path. Treat any URL's pathname as the path rather
  // than throwing, so disk-anchored resolution degrades to VFS paths.
