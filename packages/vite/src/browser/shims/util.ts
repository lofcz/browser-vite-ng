...
/** Style text with ANSI codes (Node 20.12+). Browser shim: return unstyled. */
export function styleText(
  _format: string | string[] | { [k: string]: unknown },
  text: string,
): string {
  return text;
}

/** Parse a .env file's contents into a key/value record (dotenv semantics). */
