...
export const CLIENT_ENTRY: string = process.env.VITE_BROWSER
  ? 'browser-vite/dist/client/client.mjs'
  : resolve(VITE_PACKAGE_DIR, 'dist/client/client.mjs')
// BROWSER VITE patch end
// BROWSER VITE patch: avoid path resolve that breaks when VITE_BROWSER is set
export const ENV_ENTRY: string = process.env.VITE_BROWSER
  ? 'browser-vite/dist/client/env.mjs'
  : resolve(VITE_PACKAGE_DIR, 'dist/client/env.mjs')
// BROWSER VITE patch end
